const foodSound = new Audio("Elements/foodsound.mp3");
const gamesound = new Audio("Elements/gamesound.mp3");
const gameOver = new Audio("Elements/gameover.mp3");
const move = new Audio("Elements/movement.mp3");
